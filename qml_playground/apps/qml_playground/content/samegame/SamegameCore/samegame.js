...
function victoryCheck()
{
    ...
    if(deservesBonus || !(floodMoveCheck(0,maxRow-1, -1))){
        ...
        if(isHighScore() == true) {
            ...
            nameInputDialog.width = nameInputDialog.initialWidth + nameInputText.width;
...
function isHighScore() {
    ...
    db.transaction(
        function(tx) {
            ...
            var rs = tx.executeSql('SELECT * FROM Scores WHERE gridSize = "'+maxColumn+"x"+maxRow+'" AND score > ' + gameCanvas.score);
